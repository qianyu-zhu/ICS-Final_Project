...
menu = "\n++++ Choose one of the following commands\n \
        ...
        \tc _peername_: to connect to the peer and chat\n \
        \tyou can play the following games in chatroom:\n \
        \t\tgame1: Snake Game\n \
        \t\tgame2: play Go Bang with your computer\n \
        \t\t*game3: Kill Final (multiplayer)\n \
        \t? _term_: to search your chat logs where term appears\n \
